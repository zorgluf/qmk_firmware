 ...
 */
    ...
    KC_ESC,	KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_F6,KC_F7,KC_F8,KC_F9,KC_F10,KC_F11,KC_F12, KC_PSCR,KC_SLCK,KC_BRK, KC_NO, KC_NO, KC_NO, KC_NO,    KC_NO,        \
    FR_DLR,FR_DQUO,M3_174,M3_175,FR_LPRN,FR_RPRN,FR_AT,FR_PLUS,FR_MINS,FR_SLSH,FR_ASTR,FR_EQL,FR_PERC, KC_NO, KC_BSPC,KC_INS,KC_HOME,KC_PGUP,KC_NLCK,KC_PSLS,KC_PAST,KC_PMNS,  KC_NO, KC_NO, \
    KC_TAB,FR_B,FR_EACU,FR_P,FR_O,FR_EGRV,FR_CIRC,FR_V,FR_D,FR_L,FR_J,FR_Z,FR_W,KC_ENT,KC_DEL,KC_END,KC_PGDN,KC_P7,KC_P8,KC_P9,KC_PPLS,                                KC_NO, KC_NO, \
    KC_LCTL,FR_A,FR_U,FR_I,FR_E,FR_COMM,FR_C,FR_T,FR_S,FR_R,FR_N,FR_M,FR_CCED,KC_P4,KC_P5,KC_P6,                                                             KC_NO,    KC_NO, KC_COPY, \
    MO(1),M3_136,FR_AGRV,FR_Y,FR_X,FR_DOT,FR_K,M4_0146,FR_Q,FR_G,FR_H,FR_F, KC_NO, MO(1),KC_UP,KC_P1,KC_P2,KC_P3,KC_PENT,                                    KC_NO,    KC_NO, KC_PASTE, \
    KC_LCTL,KC_LGUI,KC_LALT, KC_NO, KC_NO, KC_SPC, KC_NO, KC_NO,KC_NO, MO(2),KC_RGUI,KC_APP,KC_RCTL,KC_LEFT,KC_DOWN,KC_RGHT,KC_P0,KC_PDOT, KC_PENT,                    KC_NO, KC_CUT  \
    ),
